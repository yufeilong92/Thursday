...
public class CaseOrderTestActivity extends BaseActivity implements View.OnClickListener, GmReadTwoFragment.notification {
    ...
    private CaseCardVo mCaseCardVoTwo;
...
*/
    ...
    private void initReadViewPagerOne() {
        GmFragmentAdpater adapter = new GmFragmentAdpater(getSupportFragmentManager(), mContext, mMainDataLists, mCourseId);
        mReaderViewPagerone.setAdapter(adapter);
        ...
        mReaderViewPagerone.setOffscreenPageLimit(1);
    ...
    private void initReadViewPagerTwo() {
        mTwoAdapter = new GmFragmentAdpaterTwo(getSupportFragmentManager(), mContext, mFuDataLists, mCourseId);
...
//                            Log.e("===", "执行");
    ...
    public class GmFragmentAdpaterTwo extends FragmentStatePagerAdapter {
        ...
        public GmFragmentAdpaterTwo(FragmentManager fm, Context mContext, List<?> mListDatas, String coursid) {
            super(fm);
            this.mListDatas = mListDatas;
            this.mContext = mContext;
            this.mCourseid = coursid;
        ...
        public Fragment getItem(int position) {
            if (mListDatas.size() == 0) {
                ...
                mCaseCardVoTwo = (CaseCardVo) mListDatas.get(position);
