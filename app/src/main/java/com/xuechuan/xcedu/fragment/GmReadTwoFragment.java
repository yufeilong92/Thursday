...
//    private AnswerEvaluateAdapter mEvalueAdapter;
    ...
    private TextView mTvGmEightOneQuestionTitle;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if (mCaseCardVo == null) {
                ...
                mQuestionSqliteVo = mCaseCardVo.getVo();
            }
...
//        mEvalueAdapter = new AnswerEvaluateAdapter(mContext, mArray);
    ...
    private void initView(View view) {
        ...
        mTvGmEightOneQuestionTitle = (TextView) view.findViewById(R.id.tv_gm_eight_one_question_title);
        mTvGmEightOneQuestionTitle.setOnClickListener(this);
        ...
        mTvGmEightOneAnswerTitleContent.setOnClickListener(this);
    ...
    private void setFontSize() {
        ...
        mTvGmEightOneQuestionTitle.setTextSize(mGmFontSizeUtil.getFontSize());
...
//        mLiBResolveBuy.setBackgroundColor(mGmReadColorManger.getmLayoutBgColor());
        ...
        mTvGmEightOneQuestionTitle.setTextColor(mGmReadColorManger.getmTextTitleColor());
        mEtEightOneInputContent.setTextColor(mGmReadColorManger.getmTextTitleColor());
    ...
    private void readDataBindView() {
        ...
        mTvGmEightOneAnswerTitleContent.setText(mQuestionSqliteVo.getExplainimgStr());
        if (mCaseOrderTestActivity != null) {
